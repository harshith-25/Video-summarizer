...
class Summarizer:
    ...
    def generate_final_summary(self, segments: List[Dict], video_title: str, source_type: str = "URL", target_language: str = "en", progress_callback: Optional[Callable[[str, int], None]] = None) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "- Action Items: Provide a list of key actionable tasks, next steps, or practical recommendations deduced from the video content (minimum 1 items).\n"
            ...
            "  ],\n"
            "  \"action_items\": [\n"
            "     \"Actionable task, next step, key recommendation, or practical takeaway (max 20 words).\"\n"
            "  ],\n"
            "  \"timeline\": [\n"
